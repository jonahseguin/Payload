...
public class ObjectPreSaveEvent<X extends ObjectCacheable> extends Event {
    ...
    public ObjectPreSaveEvent(X object, OLayerType layer, PayloadObjectCache<X> objectCache) {
        this.object = object;
        this.layer = layer;
        this.objectCache = objectCache;
    }

    public ObjectPreSaveEvent(boolean isAsync, X object, OLayerType layer, PayloadObjectCache<X> objectCache) {
        super(isAsync);
        this.object = object;
        this.layer = layer;
        this.objectCache = objectCache;
