...
public class ProfileCache<T extends Profile> {
    ...
    public T getLocalProfile(Player player) {
        if (this.getLayerController().getLocalLayer().has(player.getUniqueId().toString())) {
    ...
    public T getProfile(String uniqueId) {
        ...
        if (this.getLayerController().getLocalLayer().has(uniqueId)) {
            return this.getLayerController().getLocalLayer().get(uniqueId);
        } else if (this.getLayerController().getPreCachingLayer().has(uniqueId)) {
            // Being cached currently; return their temporary profile.
            return this.getLayerController().getPreCachingLayer().get(uniqueId).getTemporaryProfile();
        } else if (this.getLayerController().getRedisLayer().has(uniqueId)) {
            return this.getLayerController().getRedisLayer().get(uniqueId);
        } else if (this.getLayerController().getMongoLayer().has(uniqueId)) {
            return this.getLayerController().getMongoLayer().get(uniqueId);
